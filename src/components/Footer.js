  ...
  return (
    <footer className="w-full bg-black flex flex-row items-center justify-center  text-left text-sm text-colors-text-c-text-grey-tertiary font-label-regular-bold mq1450:max-w-full">
      <div className="flex-1 bg-black flex flex-col items-center justify-end py-spacing-sp-120 px-0 box-border gap-[64px] max-w-[1440px] min-h-[316px] mq450:gap-[64px] mq825:gap-[64px] mq1450:max-w-full">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-[32px] max-w-full mq825:gap-[32px]">
          ...
          <div className="w-full flex flex-row items-center justify-start py-0 px-5 box-border max-w-[1200px] mq1450:max-w-full">
            <div className="flex flex-row items-start justify-start gap-[12px] max-w-full mq825:flex-wrap">
              ...
              <div className="relative leading-[20px] font-semibold mq825:w-full mq825:h-1.5">
                •
              </div>
              <div className="overflow-hidden flex flex-row items-center justify-center gap-[8px] text-colors-text-c-text-grey-secondary">
              ...
              <div className="relative leading-[20px] font-semibold text-colors-text-c-text-grey-secondary">
                Sitemap
              </div>
            </div>
          </div>
